      ...
      <body style="box-sizing: border-box;width: 100%;margin: 0;padding: 0;font-family: &quot;Roboto&quot;;font-size: 16px;">
        <div class="Container"
          ...
          <div class="Content" style="box-sizing: border-box;padding: 20px 40px;">
            ...
            <div style="height: 40px;box-sizing: border-box;"></div>
            <h2 style="box-sizing: border-box;font-size: 22px;font-weight: 400;opacity: 0.8;line-height: 1.5;margin: 0;">eNeF-Turk NFT Dünyasına
              Hoşgeldiniz.</h2>
            <div style="height: 40px;box-sizing: border-box;"></div>
            <div style="box-sizing: border-box;"><a href="https://www.enefturk.com/user/account-activation?confirmationToken=${confirmationToken}" class="Button"
                style="box-sizing: border-box;display: inline-block;background-color: #040277;color: white;padding: 10px 50px;text-align: center;">Üyeliğinizi aktive etmek için tıklayınız</a></div>
            <div style="height: 80px;box-sizing: border-box;"></div>
